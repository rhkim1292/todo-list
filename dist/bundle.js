...
const projectsDOMHandler = (() => {
	...
	const renderProjectsPage = (projects) => {
		...
		const _projectTitleFormProperty = (0,_render_todos_js__WEBPACK_IMPORTED_MODULE_0__.createFormProperty)(
			"Title",
			"input",
			"text",
			"titleName",
...
function createTodoForm(formId, closeFormId, submitFormId) {
	...
	const _todaysDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), "yyyy-MM-dd");
...
function createTodoCardDOMElement(todo, index) {
	...
	_pDueDate.textContent = `Due: ${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(todo.dueDate, "M/d/yy")}`;
	const _imgExpandDetailsBtn = createElementWithId("img", "expandDetailsBtn");
	_imgExpandDetailsBtn.setAttribute("src", _expand_details_svg__WEBPACK_IMPORTED_MODULE_1__);
	...
	_dueDateInput.setAttribute("value", (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(todo.dueDate, "yyyy-MM-dd"));
	...
	_divContent.addEventListener("click", (e) => {
		...
		switch (e.target.id) {
			case "editTitleBtn":
				...
				break;
			case "applyBtn":
				if (!_render_todos_js__WEBPACK_IMPORTED_MODULE_3__["default"].editProjectTitleForm.checkValidity())
					break;
				...
				_render_todos_js__WEBPACK_IMPORTED_MODULE_3__["default"].currProject.title =
					formData.get("project_title");
				_render_todos_js__WEBPACK_IMPORTED_MODULE_3__["default"].renderTodoListPage(
					_render_todos_js__WEBPACK_IMPORTED_MODULE_3__["default"].currProject
				);
				break;
			case "closeEditProjectTitleFormBtn":
				...
				break;
			case "addTodoBtn":
				(0,_render_todos_js__WEBPACK_IMPORTED_MODULE_3__.enableForm)(_render_todos_js__WEBPACK_IMPORTED_MODULE_3__["default"].addTodoForm, e.target);
				break;
			...
			case "todoFormSubmitBtn":
				if (!_render_todos_js__WEBPACK_IMPORTED_MODULE_3__["default"].addTodoForm.checkValidity()) {
					const _dueDateInput =
						_render_todos_js__WEBPACK_IMPORTED_MODULE_3__["default"].addTodoForm.children[3].children[1];
					const _inputDate = _dueDateInput.valueAsDate;
					if (!(0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(_inputDate)) {
			...
			case "projectFormSubmitBtn":
				if (!_render_projects_js__WEBPACK_IMPORTED_MODULE_4__["default"].form.checkValidity()) break;
			...
			case "expandDetailsBtn":
				(0,_render_todos_js__WEBPACK_IMPORTED_MODULE_3__.expandDetails)(e.target);
				break;
			case "closeDetailsBtn":
				(0,_render_todos_js__WEBPACK_IMPORTED_MODULE_3__.closeDetails)(e.target);
				break;
			case "deleteTodoBtn":
			...
			case "editTodoBtn":
				...
				currTodo =
					_render_todos_js__WEBPACK_IMPORTED_MODULE_3__["default"].currProject.listOfTodos[idxOfCurrTodo];
				...
				_dueDateInput.setAttribute(
					"value",
					(0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(currTodo.dueDate, "yyyy-MM-dd")
				);
				...
				(0,_render_todos_js__WEBPACK_IMPORTED_MODULE_3__.enableForm)(currTodoForm, e.target);
				break;
			case "closeEditTodoFormBtn":
				...
				(0,_render_todos_js__WEBPACK_IMPORTED_MODULE_3__.disableForm)(currTodoForm, currTodoEditBtn);
				break;
			case "submitEditTodoFormBtn":
				...
				currTodoHeader.children[2].textContent = `Due: ${(0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(
					currTodo.dueDate,
					"M/d/yy"
				)}`;
